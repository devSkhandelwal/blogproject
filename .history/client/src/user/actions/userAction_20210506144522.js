...
import {USER_LOGOUT, USER_LOGIN_FAIL, USER_LOGIN_REQUEST, USER_LOGIN_SUCCESS, USER_REGISTER_FAIL, USER_REGISTER_REQUEST, USER_REGISTER_SUCCESS, USER_UPDATE_REQUEST, USER_UPDATE_SUCCESS, USER_UPDATE_FAIL, USER_LIST_REQUEST, USER_LIST_SUCCESS, USER_LIST_FAIL, USER_DETAILS_REQUEST, USER_DETAILS_SUCCESS, USER_DETAILS_FAIL } from "../constants/userConstants"
...
export const userDetailsAction = (id) => async(dispatch) => {
    ...
    try{
        ...
        const {data} = await axios.post(`/user/:${id}`,config)
...
export const userUpdateAction = (name,email) => async(dispatch,getState) => {
    ...
    try{
        ...
        const {data} = await axios.post("/update",{email},config)
