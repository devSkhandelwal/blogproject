...
const MyPosts = () => {
    ...
    return (
        <>
            {
                loading ? <h2>loading</h2> : error ? <div className="error-wrapper"> <Message vareint="danger">{error}</Message></div> :(
                    myPosts.length === 0 ? (<Message vareint ="success">No Post yet</Message>):(
