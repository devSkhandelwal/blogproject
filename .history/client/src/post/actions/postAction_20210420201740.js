...
export const postCreateAction = ({title,description}) => async(dispatch) =>{
    try{
        ...
        const {data} = axios.post('/addpost',{title,description},config);
...
export const postUpdateAction = ({title,description}) => async(dispatch) =>{
    try{
        ...
        const {data} = axios.patch('/update/post',{title,description},config);
...
export const postDeleteAction = (id) => async(dispatch) =>{
    try{
        ...
        const {data} = axios.delete('/delete/post',config,{title,description});
